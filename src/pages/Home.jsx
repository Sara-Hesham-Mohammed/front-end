        ...
        <div className="p-6 min-h-screen bg-gray-900 text-white relative flex flex-col justify-center items-center">
            ...
            <div className="relative z-10 max-w-4xl mx-auto text-center">
                <h1 className="text-4xl md:text-6xl font-extrabold mb-6 bg-gradient-to-r from-teal-400 to-blue-500 bg-clip-text text-transparent">
                    Welcome to my stock Testing Page - ahmed
                </h1>

                <p className="text-lg md:text-xl mb-8">
                    This page is currently under testing. <strong className="text-teal-400">AAPL</strong> as the default.
                </p>

                <p className="text-lg md:text-xl mb-8">
                    Our motive is to provide you with an insightful and seamless experience in tracking and analyzing market data.
                </p>
